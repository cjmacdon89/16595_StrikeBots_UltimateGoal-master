...
@Autonomous(name="Auto_Grab_Block_Plus_Tray_Blue", group="")
public class Auto_Grab_Block_Plus_Tray_Blue extends LinearOpMode {
    ...
    private double timelenght = (4250/4*3);
    ...
    public void runOpMode() {
        ...
        //Stop before other robot on line just if parked
        timmer.reset();
        while (timmer.milliseconds() < 1000)
        {
            correction = checkDirection();
