...
@Autonomous(name="Auto_Grab_Block_Red", group="")
public class Auto_Grab_Block_Red extends LinearOpMode {
    ...
    private double timelenght = (2800/4*3);
    ...
    public void runOpMode() {
        ...
        timmer.reset();
        while (timmer.milliseconds() < timelenght+1700){
            correction = checkDirection();
            leftbackDrive.setPower(0.45 - correction);
            rightbackDrive.setPower(-0.45 + correction);
            leftfrontDrive.setPower(-0.45 - correction);
